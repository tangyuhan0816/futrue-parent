...
/**
 *  @Author: Yuhan.Tang
 *  @ClassName: AccountValidatorUtil
 *  @package: com.futrue.asset.utils
 *  @Date: Created in 2018/11/9 下午7:07
...
public class AccountValidatorUtil {
     ...
     * 正则表达式：验证手机号
     */
    public static final String REGEX_MOBILE = "^((17[0-9])|(14[0-9])|(13[0-9])|(15[^4,\\D])|(18[0,1-9]))\\d{8}$";
    ...
    public static void isMobile(String mobile) {
        if(!Pattern.matches(REGEX_MOBILE, mobile)){
            throw new STException("请输入合法的手机号");
        }
    }
